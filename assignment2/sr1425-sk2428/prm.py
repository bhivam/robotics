...
def prm(start, goal, robot_type, obstacles, num_samples=5000):
    ...
    for node in nodes:
        ...
        add_edges(graph, tuple(node), neighbors)
...
def visualize_prm(graph, obstacles, start, goal, path=None, dimensions=None, robot_type="freeBody"):
    ...
    for node in graph.keys():
       ...
       for neighbor in graph[node]:
           plt.plot([node[0], neighbor[0]], [node[1], neighbor[1]], c ="red", zorder=2)
           

    plt.scatter(nodes_x_values, nodes_y_values, c= "blue", zorder=1)
...
def visualize_path(path, obstacles, start, goal, robot, name="visualize.gif"):

    def visualize_path_freebody(path, obstacles, start, goal, name="visualize.gif"):
    ...
    def visualize_path_arm(path, obstacles, start, goal, name="visualize.gif"):
        figure, axes = plt.subplots()
        obstacles_corners = []
